...
class Resnet3DBuilder(object):
    ...
    @staticmethod
    def build(input_shape, num_outputs, block_fn, repetitions, reg_factor, multilabel=False):
        ...
        if num_outputs > 1 and not multilabel:
    ...
    @staticmethod
    def build_resnet_18(input_shape, num_outputs, reg_factor=1e-4, multilabel=False):
        """Build resnet 18."""
        return Resnet3DBuilder.build(input_shape, num_outputs, basic_block,
                                     [2, 2, 2, 2], reg_factor=reg_factor, multilabel=multilabel)
